    ...
    public abstract class CAL_CategoryDALBase : DALHelper
    {
        ...
        public decimal? Insert(CAL_CategoryModel objCategoryModel)
        {
            try
            {
                ...
                sqlDB.AddInParameter(dbCMD, "CategoryName", SqlDbType.VarChar, objCategoryModel.CategoryName);
                sqlDB.AddInParameter(dbCMD, "Description", SqlDbType.VarChar, objCategoryModel.Description);
